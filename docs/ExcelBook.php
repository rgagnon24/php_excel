...
/*
  ...
  | php_excel interface to libxl by Ilia Alshanetsky <illia@ilia.ws>          |
  |                                                                           |
...
class ExcelBook {
	...
	*/
	...
	/**
	* Get an Excel worksheet by its name
	*
	* @param string $name worksheet name
	* @param bool $case_insensitive (optional, default=false) Search names case insensitively if true
	* @return ExcelSheet or false if $name invalid
	*/
